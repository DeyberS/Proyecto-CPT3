...
<head>
  ...
  <title>Laboratorios | Papelera</title>
  <?php
  ...
  <div class="content-wrapper">
    ...
    $sqlLab = ("SELECT * FROM laboratorio WHERE estatus = 0 ORDER BY Id_laboratorio ASC");
    ...
    <section class="content">
      <div style="padding-bottom: 10px;">
        <a href="../farmacia_laboratorio_listado.php" class="btn-sm btn-primary pull-right"> Regresar al Listado </a>
    ...
    <div class="modal" id="ReactivarLaboratorio" tabindex="-1" role="dialog" aria-labelledby="ReactivarLaboratorioLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #dc3545; color: white;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="ReactivarLaboratorioLabel">Confirmar Desactivacion</h4>
          </div>
          <div class="modal-body">
            <p>¿Está seguro de que desea reactivar este laboratorio?</p>
          </div>
          <div class="modal-footer">
    ...
    <div class="modal" id="EliminarLaboratorio" tabindex="-1" role="dialog" aria-labelledby="EliminarLaboratorioLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header" style="background-color: #dc3545; color: white;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title" id="EliminarLaboratorioLabel">Confirmar Desactivacion</h4>
          </div>
          <div class="modal-body">
            <p>¿Está seguro de que desea eliminar este laboratorio? Esta acción no se puede deshacer.</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-second" data-dismiss="modal">Cancelar</button>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#ReactivarLaboratorio .close, #ReactivarLaboratorio .btn-second').on('click', function() {
          closeCustomModal($('#ReactivarLaboratorio'));
        });

        $('#EliminarLaboratorio .close, #EliminarLaboratorio .btn-second').on('click', function() {
          closeCustomModal($('#EliminarLaboratorio'));
        });

        $(document).on('click', '.btn-reactivar', function(e) {
          e.preventDefault();
          var IdLaboratorio = $(this).data('id');
          var urlReactivar = "../../../cfg/reactivar/reactivar_laboratorio.php?Id=" + IdLaboratorio;
          $('#reactivar').attr('href', urlReactivar);
          $('#ReactivarLaboratorio').modal('show');
        })

        $(document).on('click', '.btn-eliminar', function(e) {
          e.preventDefault();
          var IdLaboratorio = $(this).data('id');
          var urlEliminar = "../../../cfg/eliminar/eliminar_laboratorio.php?Id=" + IdLaboratorio;
          $('#eliminar').attr('href', urlEliminar);
          $('#EliminarLaboratorio').modal('show');
        })
