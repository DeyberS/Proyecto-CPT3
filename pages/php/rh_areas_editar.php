    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#"><i class="fa fa-users"></i>Areas</a></li>
          ...
          <div class="col-md-12">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Informacion del Area</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane active" id="tab_1" style="height:180px;">
                  <div class="box-body">
                    <form id="formularioArea" action="../../cfg/editar/editar_area.php" class="form-group" method="POST" novalidate>
                    <?php
                      include("../../cfg/conexion.php");

                      // 1. Cargar datos de la patología a editar
                      $patologia_id = $_GET['Id'] ?? 0;
                      $sql = "SELECT * FROM departamento WHERE Id_departamento =" . $patologia_id;
                      $resultado = $conexion->query($sql);
                      $row = $resultado->fetch_assoc();
                      ?>

                      <input type="hidden" name="Id" value="<?= $row['Id_departamento']; ?>">

                    <label class="control-label"></label>
                      <div class="col-sm-4 form-group" id="group_nombre">
                        <p>Nombre del Area (*)</p>
                        <input type="text" class="form-control" placeholder="" name="nombre_area" id="nombre_area" value="<?php echo htmlspecialchars($row['nombre_departamento']); ?>" required>
                      </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="rh_areas_listado.php" class="btn btn-danger">Abandonar Formulario</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="modalGuardar" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body"><p>¿Está seguro de que desea actualizar la informacion del Area?</p></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
    ...
    <script>
      $(document).ready(function() {
        ...
        function verificarAreaYMostrarModal() {
          ...
          const id_area = $('input[name="Id"]').val(); // Captura el ID para ignorarlo
          ...
          $.ajax({
            url: 'get/verificar_existencia_area.php', // Ojo con la ruta según tu estructura
            method: 'POST',
            dataType: 'json',
            data: { nombre: nombre, id: id_area },
            success: function(response) {
              ...
              if (response.existe_nombre) {
                errores_ajax.push(`⚠️ Ya existe otra área registrada con el nombre: ${nombre}`);
              ...
              if (errores_ajax.length > 0) {
                ...
                // Si no hay duplicado, mostrar el modal de confirmación
        ...
        const campos = [document.getElementById("nombre_area")];
