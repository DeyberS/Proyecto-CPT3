    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li><a href="#"><i class="fa fa-users"></i>alergia</a></li>
          ...
          <div class="col-md-12">
            <div class="nav-tabs-custom">
              <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab">Informacion del alergia</a></li>
              </ul>
              <div class="tab-content">
                <div class="tab-pane active" id="tab_1" style="height:150px;">
                  <div class="box-body">
                    <form id="formularioAlergia" action="../../cfg/editar/editar_alergia.php" class="form-group" method="POST" novalidate>
                    <?php
                      include("../../cfg/conexion.php");

                      // 1. Cargar datos de la patología a editar
                      $patologia_id = $_GET['Id'] ?? 0;
                      $sql = "SELECT * FROM alergias_conocidas WHERE Id_alergias_conocidas =" . $patologia_id;
                      $resultado = $conexion->query($sql);
                      $row = $resultado->fetch_assoc();
                      ?>

                      <input type="hidden" name="Id" value="<?= $row['Id_alergias_conocidas']; ?>">

                    <label class="control-label"></label>
                      <div class="col-sm-4 form-group" id="group_nombre">
                        <p>Nombre del alergia (*)</p>
                        <input type="text" class="form-control" placeholder="" name="nombre_alergia" id="nombre_alergia" value="<?php echo htmlspecialchars($row['nombre_alergia']); ?>" required>
                      </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="salud_alergias_listado.php" class="btn btn-danger">Abandonar Formulario</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal" id="modalGuardar" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body"><p>¿Está seguro de que desea actualizar la informacion de la Alergia?</p></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
