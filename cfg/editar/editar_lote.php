...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare("UPDATE lotes_medicamentos SET Id_descripcion_medicamento = ?, Id_proveedor = ?, Lote = ?, fecha_fabricacion = ? , fecha_vencimiento = ?, estado_lote = ? WHERE Id = ?");
        $stmt->bind_param("iissssi", $medicamento, $proveedor, $nombre, $fecha_fabricacion, $fecha_vencimiento, $estado_lote, $id);
