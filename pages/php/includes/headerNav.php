            ...
            <li class="dropdown user user-menu">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="pages/php/cfg_usuario_editar.php?Id=<?php echo $_SESSION['id'] ?>" class="btn btn-default btn-flat">Editar Mi Usuario</a>
                  </div>
          ...
          <?php if (isset($_SESSION["permisos"])) : ?>
            ...
            <?php if ($usar_vista_anidada) : ?>
              <?php if (in_array('Gestionar Consultas', $_SESSION["permisos"])) : ?>
                <li class="treeview">
                  <a href="pages/php/consulta_listado.php">
              ...
              <?php if (in_array('Gestionar Citas', $_SESSION["permisos"])) : ?>
                <li class="treeview">
                  <a href="pages/php/citas_medicas_listado.php">
              ...
              <?php if (in_array('Gestionar Pacientes', $_SESSION["permisos"])) : ?>
                <li class="treeview">
                  <a href="pages/php/pacientes_listado.php">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <?php if (in_array('Ver Sintomas', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/salud_sintomas_listado.php">Sintomas</a></li>
                    <?php endif; ?>
                  </ul>
                </li>
              <?php endif; ?>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <?php if (in_array('Ver Medicos', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/rh_medico_listado.php"></i>Medicos</a></li>
                    <?php endif; ?>
                    <?php if (in_array('Ver Areas', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/rh_areas_listado.php"><i class="fa fa-user-plus"></i>Areas</a></li>
                    <?php endif; ?>
                    <?php if (in_array('Ver Especialidades', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/rh_especialidades_listado.php"><i class="fa fa-user-plus"></i>Especialidades</a></li>
                    <?php endif; ?>
                  </ul>
                </li>
              <?php endif; ?>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <?php if (in_array('Ver Usuarios', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/cfg_usuario_listado.php">Usuarios</a></li>
                    <?php endif; ?>
                    <?php if (in_array('Ver Roles', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/cfg_roles_listado.php">Roles</a></li>
                    <?php endif; ?>
                    <?php if (in_array('Ver Permisos', $_SESSION["permisos"])) : ?>
                      <li><a href="pages/php/cfg_permisos_listado.php">Permisos</a></li>
                    <?php endif; ?>
                  </ul>
                </li>
              <?php endif; ?>
            ...
            <?php else : ?>
              ...
              <?php if (in_array('Gestionar Pacientes', $_SESSION["permisos"])) : ?>
                ...
                <?php if (in_array('Ver Pacientes', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/pacientes_listado.php"><img src="recursos/imagenes/iconos/Paciente_icon.png" style="height:18px; width:18; margin-top:-4px; margin-right:10px;"> <span>Censo General</span></a></li>
                  <li><a href="pages/php/pacientes_menores_listado.php"><i class="fa fa-child" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/people/child_care@2x.png" style="height:20px; width:20; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Censo Menores</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Representantes', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/representantes_listado.php"><i class="fa fa-users" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/people/i_groups_perspective_crowd@2x.png" style="height:20px; width:20; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Representantes</span></a></li>
                <?php endif; ?>
              <?php endif; ?>
              ...
              <?php if (in_array('Gestionar Salud', $_SESSION["permisos"])) : ?>
                ...
                <?php if (in_array('Ver Patologias', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/salud_patologias_listado.php"><img src="recursos/imagenes/iconos/patologias.png" style="height:18px; width:18; margin-top:-4px; margin-right:10px;"> <span>Patologías</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Alergias', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/salud_alergias_listado.php"><i class="fa fa-exclamation-triangle" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/ppe/ppe-mask@2x.png" style="height:20px; width:20; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Alergias</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Sintomas', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/salud_sintomas_listado.php"><i class="fa fa-heartbeat" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/conditions/chills@2x.png" style="height:20px; width:20; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Síntomas</span></a></li>
                <?php endif; ?>
              <?php endif; ?>
              ...
              <?php if (in_array('Gestionar Farmacia', $_SESSION["permisos"])) : ?>
                ...
                <?php if (in_array('Ver Inventario', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/farmacia_inventario_listado.php"><img src="recursos/imagenes/iconos/farmacia_icon.png" style="height:18px; width:18; margin-top:-4px; margin-right:10px;"> <span>Inventario General</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver kardex de medicamentos', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/farmacia_inventario_kardex.php"><i class="fa fa-list-alt" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/objects/spreadsheets@2x.png" style="height:18px; width:18; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Kardex</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Medicamentos', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/farmacia_medicamentos_listado.php"><i class="fa fa-medkit" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/medications/blister_pills_round_x14@2x.png" style="height:18px; width:18; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Medicamentos</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Proveedores', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/farmacia_proveedores_listado.php"><i class="fa fa-truck" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/people/city_worker@2x.png" style="height:18px; width:18; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Proveedores</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Laboratorios', $_SESSION["permisos"])) : ?>
              ...
              <?php if (in_array('Gestionar RH', $_SESSION["permisos"])) : ?>
                ...
                <?php if (in_array('Ver Medicos', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/rh_medico_listado.php"><img src="recursos/imagenes/iconos/medico.png" style="height:20px; width:20; margin-top:-4px; margin-right:10px;"> <span>Médicos</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Areas', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/rh_areas_listado.php"><i class="fa fa-hospital-o" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/places/emergency_post@2x.png" style="height:18px; width:18; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Áreas</span></a></li>
                <?php endif; ?>
                <?php if (in_array('Ver Especialidades', $_SESSION["permisos"])) : ?>
                  <li><a href="pages/php/rh_especialidades_listado.php"><i class="fa fa-star" style="margin-right:10px; font-size:18px;"><img src="recursos/imagenes/iconos/filled/specialties/coronary_care_unit@2x.png" style="height:18px; width:18; margin-top:-4px; margin-right:0px; filter:invert();"></i> <span>Especialidades</span></a></li>
                <?php endif; ?>
              <?php endif; ?>
    ...
    <script>
      $(document).ready(function() {
        ...
        $('#confirmarSalida').on('click', function(e) {
          ...
          var rutaCerrarSesion = 'cfg/lgout.php';
