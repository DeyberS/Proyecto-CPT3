            ...
            <div class="nav-tabs-custom">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab_1" style="height:150px;">
                  <div class="box-body">
                    <form id="formularioSintoma" action="../../cfg/editar/editar_sintoma.php" class="form-group" method="POST" novalidate>
                    <?php
                      include("../../cfg/conexion.php");

                      // 1. Cargar datos de la patología a editar
                      $patologia_id = $_GET['Id'] ?? 0;
                      $sql = "SELECT * FROM sintomas WHERE Id_sintomas =" . $patologia_id;
                      $resultado = $conexion->query($sql);
                      $row = $resultado->fetch_assoc();
                      ?>

                      <input type="hidden" name="Id" value="<?= $row['Id_sintomas']; ?>">

                    <label class="control-label"></label>
                      <div class="col-sm-4 form-group" id="group_nombre">
                        <p>Nombre del sintoma (*)</p>
                        <input type="text" class="form-control" placeholder="" name="nombre_sintoma" id="nombre_sintoma" value="<?php echo htmlspecialchars($row['nombre_sintoma']); ?>" required>
                      </div>
    ...
    <div class="modal" id="modalGuardar" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body"><p>¿Está seguro de que desea actualizar la informacion del Sintoma?</p></div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
