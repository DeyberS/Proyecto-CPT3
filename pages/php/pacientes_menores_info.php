...
LEFT JOIN pais paisnac ON paisnac.Id_Pais = estnac.Id_Estado
...
GROUP BY p.id";
            ...
            $id_pais_nac = $row['Pais_Nac'] ?? '';
            $id_pais_dir = $row['Id_Pais_Dir'] ?? '';
            $id_estado_nac = $row['Estado_Nac'] ?? '';
            $id_municipio_nac = $row['Municipio_Nac'] ?? '';
            $id_estado_dir = $row['Estado_Dir'] ?? '';
            $id_municipio_dir = $row['Municipio_Dir'] ?? '';
            $id_sector_dir = $row['Sector_Dir'] ?? '';
                  ...
                  <div class="row info-cv-body">
                    ...
                    <div class="col-md-4 cv-sidebar">
                      ...
                      <div class="cv-section alert-section">
                        <h4><i class="fa fa-phone"></i> Información del Representante</h4>
                        <p><strong>Cedula:</strong><?php echo $tipo_cedula_representante; ?>-<?php echo $cedula_representante; ?></p>
                        <p><strong>Nombre y Apellido:</strong><?php echo $nombre_representante; ?> <?php echo $apellido_representante; ?></p>
                        <p><strong>Parentesco:</strong><?php echo $relacion_menor; ?></p>
                        <p><strong>N. Telefono:</strong> <?php echo $id_prefijo_representante; ?>-<?php echo $telefono_representante; ?></p>
                      </div>

                      <div class="cv-section">
                        <h4><i class="fa fa-map-marker"></i> Lugar de Nacimiento</h4>
                        <p><strong>País:</strong> <?php echo $id_pais_nac; ?></p>
                        <p><strong>Estado:</strong> <?php echo $id_estado_nac; ?></p>
                        <p><strong>Municipio:</strong> <?php echo $id_municipio_nac; ?></p>
                      </div>
                    ...
                    <div class="col-md-8 cv-main-content">
                      ...
                      <div class="cv-section">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <strong>Etnia:</strong> <span class="badge bg-<?php echo ($etnia_menor == 'Si' ? 'green' : 'red'); ?>"><?php echo $row['etnia']; ?></span> </p>
                            <p> <strong>Tipo de Etnia:</strong> <?php echo $etnia_tipo_menor ?: 'Ninguna'; ?> </p>
                          </div>
                          <div class="col-sm-6">
                            <p><strong>¿Analfabeta?:</strong> <span class="badge bg-<?php echo ($analfabeta_menor == 'Si' ? 'green' : 'red'); ?>"><?php echo $row['analfabeta']; ?></span></p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="cv-section">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <p><strong>Estado:</strong> <?php echo $id_estado_dir; ?></p>
                            <p><strong>Municipio:</strong> <?php echo $id_municipio_dir; ?></p>
                            <p><strong>Sector:</strong> <?php echo $id_sector_dir; ?></p>
                            <p><strong>Tiempo de Residencia:</strong> <?php echo $tiempo_residencia; ?> <?php echo $tiempo; ?></p>
                          </div>

                          <div class="col-sm-6">
                            <p><strong>Punto de Refencia:</strong> <?php echo $referencia ?: 'Ninguno'; ?></p>
                            <p><strong>Avenida/Calle:</strong> <?php echo $avenida_calle ?: 'Ninguna'; ?></p>
                          </div>
                        </div>
                      </div>
                ...
                <section id="new" style="margin-bottom:4%;">
                  <div class="row info-cv-body">
                    ...
                    <div class="col-md-4 cv-sidebar">
                      ...
                      <div class="cv-section alert-section">
                        <h4><i class="fa fa-exclamation-triangle"></i> <strong> Alergias:</strong></h4>
                        <?php
                        $alergias = explode('||', $row['alergias_data']);
                        if (!empty($row['alergias_data'])) {
                      ...
                      <div class="cv-section">
                        ...
                        <?php
                        $patologias = explode('||', $row['patologias_data']);
                        if (!empty($row['patologias_data'])) {
