...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $conexion->prepare("UPDATE proveedor SET nombre_proveedor = ? WHERE Id_proveedor = ?");
        ...
        $conexion->commit();
        $_SESSION['mensaje_user_exito'] = '✅ Éxito: El proveedor ha sido actualizado correctamente.';
