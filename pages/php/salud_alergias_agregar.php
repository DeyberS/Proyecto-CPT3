  ...
  <div class="content-wrapper">
        ...
        <div class="col-md-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#tab_1" data-toggle="tab">Informacion de la Alergia</a></li>
            </ul>
            <div class="tab-content" style="height:170px;">
              <div class="tab-pane active" id="tab_1">
                <div class="box-body">
                  <form action="../../cfg/agregar/agregar_alergia.php" id="formularioAlergia" class="form-group" method="POST" novalidate>

                    <div class="col-sm-4 form-group" id="group_nombre">
                      <p>Nombre de la alergia (*):</p>
                      <input type="text" class="form-control" name="nombre_alergia" id="nombre_alergia" required>
                    </div>
    ...
    <div class="modal" id="modalGuardar" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Está seguro de que desea guardar la nueva Alergia?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
    ...
    <script>
      $(document).ready(function() {
        ...
        const campos = [document.getElementById("nombre_alergia")];
