...
<head>
  ...
  <title>Especialidades | Añadir</title>
  <?php
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="height:180px;">
              <div class="tab-pane active" id="tab_1">
                <div class="box-body">
                  <form action="../../cfg/agregar/agregar_especialidad.php" id="formularioEspecialidad" class="form-group" method="POST" novalidate>
    ...
    <div class="modal" id="modalGuardar" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Está seguro de que desea guardar la nueva Especialidad?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
    ...
    <script>
      $(document).ready(function() {
        ...
        function verificarEspecialidadYEnviar() {
          ...
          $.ajax({
            url: 'get/verificar_existencia_especialidad.php',
            method: 'POST',
            dataType: 'json',
            data: {
              nombre: nombre
