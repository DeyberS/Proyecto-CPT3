        ...
        <table class="table table-sm table-hover mt-4" width="100%" height="20" id="t_user">
          ...
          <tbody class="tbody" width="100%" style="font-size: 12px;">
            ...
            <?php }
              ...
              echo "<tr><td colspan='6'>No se encontraron lotes inactivos.</td></tr>";
            } ?>
          </tbody>
        </table>
      </div>
      ...
      $(document).ready(function() {
        ...
        $('#buscar').on('keyup', function() {
          ...
          timer = setTimeout(function() {
            ...
            var url = 'farmacia_lotes_papelera_listado.php?' + filtrosActuales;
            cargarDatosAjax(url);
          }, 400);
        });
        ...
        $('#formBusquedaAvanzada').on('submit', function(e) {
          e.preventDefault();
          var url = 'farmacia_lotes_papelera_listado.php?' + $(this).serialize();
