          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="height:180px;">
              <div class="tab-pane active" id="tab_1">
                <div class="box-body">
                  <form action="../../cfg/agregar_alergia.php" id="formularioAlergia" class="form-group" method="POST" novalidate>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="cfg_alergias_listado.php" class="btn btn-danger">Abandonar Formulario</a>
          </div>
        </div>
      </div>
    </div>
