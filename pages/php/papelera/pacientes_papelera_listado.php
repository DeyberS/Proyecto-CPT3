...
<head>
  ...
  <title>Pacientes | Papelera</title>
  <?php
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Pacientes Inactivos (<?php echo $total_pacientes; ?>)
      </h1>
      <ol class="breadcrumb">
    ...
    <?php if (isset($_SESSION["permisos"])) : ?>
      <section class="content">
        <div style="padding-bottom: 10px;">
          <a href="../pacientes_listado.php" class="btn-sm btn-primary pull-right"><i class="fa fa-user-plus"></i> Regresar al Listado </a>
        ...
        <div id="contenedorTabla">
          <table class="table table-sm table-hover mt-4" width="100%" height="20" id="t_user">
            ...
            <tbody class="tbody" width="100%" style="font-size: 12px;">
              ...
              // 2. Definir el filtro base (Pacientes mayores de 18 y estatus 0)
              $donde = "WHERE r.Id_rol = 3 AND TIMESTAMPDIFF(YEAR, p.fecha_nacimiento, CURDATE()) >= 18 AND p.estatus = 0";

              // 3. Agregar condición de búsqueda si existe
              if ($busqueda != '') {
              ...
              ?>
                  <tr>
                    ...
                    <?php if (in_array('Gestionar acciones de pacientes', $_SESSION["permisos"])) : ?>
                      <td>
                        <?php if (in_array('Reactivar Pacientes', $_SESSION["permisos"])) : ?>
                          <a href="../../../cfg/reactivar/reactivar_paciente.php?Id=<?php echo $row['id'] ?>" class="btn-sm btn-success" title="Reactivar"><img src="../../../recursos/imagenes/iconos/reactivar.png" style="width:15px; height:15px;"></a>
                        <?php endif; ?>
                        <?php if (in_array('Eliminar Pacientes', $_SESSION["permisos"])) : ?>
                          <a href="../../../cfg/eliminar/eliminar_paciente.php?Id=<?php echo $row['id'] ?>" class="btn-sm btn-danger" title="Eliminar" onclick="return confirm('¿Está seguro de que desea eliminar permanentemente a este paciente? Esta acción no se puede deshacer.');"><img src="../../../recursos/imagenes/iconos/Delete.png" style="width:15px; height:15px;"></a>
                        <?php endif; ?>
                      </td>
                    <?php endif; ?>
                  </tr>
      ...
      <script>
        $(document).ready(function() {
          ...
          $(document).on('click', '.btn-reactivar', function(e) {
            ...
            var urlReactivar = "../../../cfg/reactivar/reactivar_paciente.php?Id=" + IdPaciente;
          ...
          $(document).on('click', '.btn-eliminar', function(e) {
            e.preventDefault();
            var IdPaciente = $(this).data('id');
            var urlEliminar = "../../../cfg/eliminar/eliminar_paciente.php?Id=" + IdPaciente;
